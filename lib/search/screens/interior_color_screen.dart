...
class InteriorColorScreen extends StatelessWidget {
  const InteriorColorScreen({super.key});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              AppLocalizations.of(context)!.interiorColor,
      ...
      body: colors.loading
          ...
          : ListView.separated(
              itemCount: colors.insideColors.length,
              ...
              itemBuilder: (_, i) {
                final color = colors.insideColors[i];
                final selected =
                    search.selectedInsideColorIds.contains(color.id);
                ...
                return ListTile(
                  ...
                  onTap: () => search.toggleInsideColor(color.id),
                );
              },
            ),
          ...
          children: [
            Expanded(
              child: ElevatedButton(
                onPressed: search.selectedInsideColorIds.isNotEmpty
                    ? search.clearColors
                    : null,
